...
<h4 align="center" style="font-weight:600px; ">Grievance Redressal Portal</h4>
        <div class="row">
            ...
            <center><h2 class="fw-bold mb-1 text-uppercase mt-1">Student Login</h2>
              ...
              <form action="logcode.php" method="post">
                ...
                <center><p class="mb-0" style="font-weight:500;">Don't have an account? <a href="ragister.php" class="">Register here</a></center>
</form>
</div>
        </div>
