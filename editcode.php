...
<a href="#" style="text-decoration:none;"><h6 style="color: black; padding-top: 8px;padding-left:11px;">
        ...
        <div class="col-sm-10 p-0 mt-2"style="width:81.4%;">
            <nav class="navbar navbar-expand-lg"style="background-color:rgb(231, 226, 153);">
              ...
              <div style="border:1px solid; height:210px; width:320px; margin-left:30px; margin-top:20px; border-radius:10px;">
             <label style="margin-top:20px; margin-left:20px; font-weight:600;"> Edit College</session><br/>
             <input type="hidden" name="cid" style="border-radius:10px; height:40px; width:250px;" value="<?php echo $row['cid']; ?>"/><br><br/>
             <input type="text" name="col" style="border-radius:10px; height:40px; width:250px;" value="<?php echo $row['college']; ?>"/><br><br/>
             <input type="submit" value="Edit College" style="border-radius:10px;width:130px;height:40px; font-weight:600; background-color:brown;color:white;"/>
    </div><br/>
             </form> 
