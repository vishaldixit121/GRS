...
$query="select * from tbl_co_type order by coid";
...
<a href="../user_dashboard.php" style="text-decoration:none;"><h6 style="color: black; padding-top: 8px;padding-left:11px;">
        ...
        <div class="col-sm-10 p-0 mt-2"style="width:81.4%;">
            <nav class="navbar navbar-expand-lg"style="background-color:rgb(231, 226, 153);">
                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarText">
                    ...
                    <span class="navbar-text">
                     ...
                     <img src="../images/adminicon.png" style="height: 30px; width: 30px; border-radius: 50%;"/>
                    </span>
                  </div>
                </div>
              </nav>
              ...
              <form action="com_t_code.php" method="post">
              <div style="border:1px solid; height:180px; width:300px; margin-left:30px; margin-top:20px; border-radius:10px;">
             <label style="margin-top:20px; margin-left:20px; font-weight:600;">Complaint Type</label><br/>
             <input type="text" name="complaint" style="border-radius:10px; height:40px; width:250px;"/><br><br/>
             <input type="submit" value="Add C_type" style="border-radius:10px;width:130px;height:40px; font-weight:600; background-color:brown;color:white;"/>
    </div><br/>
             </form> 
             <table style="height:300px; border:1px solid; margin-left:30px; width:800px;">
              <tr>
                <th>S.No</th>
              ...
              <td><?php echo $a;?></td>
                ...
                <td><img src="../images/adminicon.png" width="40px;" height="40px;"/> <?php echo "admin";?></td>
                <td><a href="comedit.php?id=<?php echo $row['coid']; ?>">edit</a></td>
                <td><a href="comdelete.php?id=<?php echo $row['coid']; ?>"><i class="fa-solid fa-trash" style="color: #f03c0f;font-size:25px;"></i></a></td>
              </tr>
              <?php
              $a++;
              } 
