        ...
        <div class="col-sm-10 p-0 mt-2"style="width:81.4%;">
            <nav class="navbar navbar-expand-lg"style="background-color:rgb(231, 226, 153);">
              ...
              <form action="supdate.php" method="post">
                <div style="border:1px solid; height:220px; width:320px; margin-left:30px; margin-top:20px; border-radius:10px;">
             <label style="margin-top:20px; margin-left:20px; font-weight:600;">Session</session><br/>
             <input type="hidden" name="se" style="border-radius:10px; height:40px; width:250px;" value="<?php echo $row['sid'];?>"/><br><br/>
             <input type="text" name="ses" style="border-radius:10px; height:40px; width:250px;" value="<?php echo $row['session'];?>"/><br><br/>
             <input type="submit" value="Edit Session" style="border-radius:10px;width:130px;height:40px; font-weight:600; background-color:brown;color:white;"/>
    </div> <br/>
            </form>
