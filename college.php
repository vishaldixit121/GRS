...
<a href="#" style="text-decoration:none;"><h6 style="color: black; padding-top: 8px;padding-left:11px;">
                    ...
                    <hr></hr>
                    <a href="usermanagement.php" style="text-decoration:none;"><h6 style="color: black; padding-top: 8px;padding-left:11px;">
        ...
        <div class="col-sm-10 p-0 mt-2"style="width:81.4%;">
            <nav class="navbar navbar-expand-lg"style="background-color:rgb(231, 226, 153);">
              ...
              <nav class="navbar navbar-expand-lg mt-1" style="box-shadow:1px 1px 2px black; background-color:rgb(231, 226, 153);">
                <div class="container-fluid">
                  <a class="navbar-brand" href="#"style="font-weight:600">College</a>
                  <a class="navbar-brand" href="#"style="font-weight:600">College</a>
                  <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                  </button>
             ...
             <label style="margin-top:20px; margin-left:20px; font-weight:600;">College</session><br/>
             <input type="text" name="col" style="border-radius:10px; height:40px; width:250px;"/><br><br/>
             <input type="submit" value="Add College" style="border-radius:10px;width:130px;height:40px; font-weight:600; background-color:brown;color:white;"/>
    </div><br/>
             </form> 
             
             <table border="1" style="margin-left:30px;  width:950px;">
                <tr>
                    <th>S.No</th>
                    <th>Colleges</th>
                ...
                <?php
                    ...
                    <td><a href="editcode.php?id=<?php echo $row['cid']; ?>">edit</a></td>
                    <td><a href="cdelete.php?id=<?php echo $row['cid']; ?>"><i class="fa-solid fa-trash" style="color: #f03c0f;font-size:25px;"></i></a></td>
                    </tr>
                    <?php
                    $a++;
                    }
