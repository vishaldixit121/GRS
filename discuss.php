...
Discussion Forum</h6></a>
    ...
    <label style="font-weight:600;font-size:20px; margin-top:8px;">Add Question</label><br/>
    <textarea name="ques" style="width:300px;margin-top:10px;border-radius:10px;"></textarea><br/>
...
<table border="1px" align="center" id="table">
    ...
    <tr>
        ...
        <td><a href="viewdiscuss.php?qid=<?php echo $row['qid']; ?>">View</a> </td>
    </tr>
    <?php 
    $a++;  
    }
